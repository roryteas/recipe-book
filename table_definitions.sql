...
create table plan(id INTEGER PRIMARY KEY AUTOINCREMENT,name text, start_date text, end_date text)
create table plan_recipe(plan_recipe_id INTEGER PRIMARY KEY AUTOINCREMENT, plan_id INTEGER, recipe_id INTEGER,  FOREIGN KEY (plan_id) REFERENCES plan(id), FOREIGN KEY (recipe_id) REFERENCES recipe(id))
